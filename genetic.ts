...
export class People {
    ...
    async predict(distance) {
        let move = await this.neural.predict(distance);
        return move;
    }
...
export class Genetic {
    ...
    public async setWinners() {
        ...
        // })
         ...
         this.genomaWinner1 = await this.peoples[this.population -1].neural.getWeights();
         this.genomaWinner2 = await this.peoples[this.population -2].neural.getWeights();
